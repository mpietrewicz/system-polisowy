...
public class Amount implements Serializable {
    ...
    public BigDecimal getBigDecimal() { // todo: do usuięcia - zamponij o BigDecimal!
        return value;
    }
    ...
    public Amount subtract(Amount amount) {
        ...
        if (subtractionResult.signum() >= 0) {
            ...
            throw new IllegalStateException("Wynik odejmowania ktow nie może być mniejszy od zera");
        }
    }
